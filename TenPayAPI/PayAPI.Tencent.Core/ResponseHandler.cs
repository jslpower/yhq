    ...
    public class ResponseHandler
    {
        ...
        public ResponseHandler(HttpContext httpContext)
        {
            ...
            if (this.httpContext.Request.InputStream.Length > 0)
            {
                ...
                StreamReader readStream = new StreamReader(this.httpContext.Request.InputStream, encode);
                ...
                // System.IO.File.WriteAllText(httpContext.Server.MapPath("/log/" + DateTime.Now.ToFileTime() + ".log"), responseText.ToString());

                XmlDocument xmlDoc = new XmlDocument();
                xmlDoc.LoadXml(responseText.ToString());
        ...
        public virtual Boolean isTenpaySign()
        {
            ...
            return getParameter("sign").ToUpper().Equals(sign);
        }
