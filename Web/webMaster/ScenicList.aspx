<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScenicList.aspx.cs" Inherits="Eyousoft_yhq.Web.webMaster.ScenicList" %>
...
<body>
    <form action="/webMaster/ScenicList.aspx" method="get" name="form1" id="form1">
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $(".toolbar_add").click(function() {
                pageOpt.ShowBoxy({ iframeUrl: "/webMaster/ScenicAdd.aspx?dotype=add", title: "添加", width: "660px", height: "600px" });
            });
            $(".toolbar_update").click(function() {
                ...
                if (pageOpt.getChkids().length == 1) {
                    pageOpt.ShowBoxy({ iframeUrl: "/webMaster/ScenicAdd.aspx?dotype=edit&id=" + pageOpt.getChkids(), title: "修改", width: "660px", height: "600px" });
                }
            ...
            $(".toolbar_delete").click(function() {
                ...
                { tableToolbar._showMsg("请选择要操作的是数据！", function() { return false; }); }
                    ...
                    tableToolbar.ShowConfirmMsg("确定要删除该产品?", function() { pageOpt.GoAjax("/webMaster/ScenicList.aspx?dotype=delete&ids=" + pageOpt.getChkids()) });
                }
            });
