<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScenicAdd.aspx.cs" Inherits="Eyousoft_yhq.Web.webMaster.ScenicAdd" %>
            ...
            Save: function() {
                if (this.FormCheck()) {
                    ...
                    $.newAjax({
                        type: "post",
                        cache: false,
                        url: "/webMaster/ScenicAdd.aspx?save=save&" + $.param(pageOpt.Params),
                        data: $("#btnSave").closest("form").serialize(),
                        dataType: "json",
                        success: function(ret) {
                            //ajax回发提示
                            if (ret.result == "1") {
                                parent.tableToolbar._showMsg(ret.msg, function() { parent.window.location.href = "/webMaster/ScenicList.aspx"; });
                            } else {
