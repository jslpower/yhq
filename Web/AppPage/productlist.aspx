<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="productlist.aspx.cs" Inherits="Eyousoft_yhq.Web.productlist" %>
 ...
 */#pullDown, #pullUp
        ...
        @-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframes@-webkit-keyframesloading{from{-webkit-transform:rotate(0deg)translateZ(0);}
        to
        {
	...
	generatedCount = 0;
        ...
        function pullUpAction() {
            setTimeout(function() {	// <-- Simulate network congestion, remove setTimeout from production!
                ...
                $("#pageindex").val(index);
                var para = { productName: $("[name=searchbox]").val(), mark: 1, pageindex: $("#pageindex").val(), isGet: 1, proType: '<%= EyouSoft.Common.Utils.GetQueryStringValue("proType") %>' };
                $.ajax({
                    type: "Get",
...
<body>
    ...
    <div class="warp">
        ...
        <div class="footer" id="footer">
            <ul>
                <li>&nbsp;&nbsp;<a href="Default.aspx"><img src="/images/shouye.png" alt="" /></a></li>
                <li>&nbsp;&nbsp;<a href="register.aspx"><img src="/images/huiyuan.png" alt="" /></a></li>
            </ul>
        </div>
    </div>
    </form>
    ...
    <script type="text/javascript">
        $(function() {
            $(".searchbtn").click(function() {
                window.location.href = "productlist.aspx?productName=" + $("[name=searchbox]").val() + "&proType=" + $("#proType").val();
            })
        })
    </script>
