<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YouJiEdit.aspx.cs" Inherits="Eyousoft_yhq.Web.HuiYuanWeiXin.YouJiEdit" %>
...
<body>
    <form id="form1">
    <input type="hidden" name="hidyid" id="hidyid" value="<%= EyouSoft.Common.Utils.GetQueryStringValue("yid") %>" />
    <div class="warp">
        <div class="youji_main">
            <div class="youji_fabu_titleone">
                <span>标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题：</span><input type="text" id="txtTitle" class="u-input" value="<%=yjTitle %>"
                    name="txtTitle"></div>
                    <div class="youji_fabu_titleone">
                <span>微信码：H</span><input type="text" id="txtHma" class="u-input" value="<%= wxma%>" name="txtHma" maxlength="5"></div>
                    ...
                    <div class="youji_fabu_box">
                        <ul>
                            ...
                            <input type="hidden" id="txtTuXiangMediaId<%# Container.ItemIndex+1 %>" name="txtTuXiangMediaId"
                                value="<%# Eval("ImgFile") %>" />
                            <li id="test">图片：<a href="javascript:void(0)" class="uplode_img">上传图片</a><em class="icon_em"></em>
                            </li>
...
<script type="text/javascript">
    var iPage = {
        ...
        bcF3: function(obj) {
            ...
            $.ajax({ type: "POST", url: "YouJiEdit.aspx?doType=baocun", data: $("#form1").serialize(), cache: false, dataType: "json", async: false,
